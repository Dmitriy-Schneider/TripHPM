...
<!-- SCREENSHOT: Главный экран со списком командировок -->
*Скриншот: Добавить изображение главного экрана*

### Создание командировки
<!-- SCREENSHOT: Форма создания командировки -->
*Скриншот: Добавить изображение формы создания*

### Загрузка и распознавание чеков
<!-- SCREENSHOT: Интерфейс загрузки чеков с распознанными данными -->
*Скриншот: Добавить изображение загрузки чеков*

### Генерация документов
<!-- SCREENSHOT: Этапы генерации документов -->
*Скриншот: Добавить изображение генерации документов*
