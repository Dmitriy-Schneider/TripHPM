...
| Детали командировки | Установка даты |
|:---:|:---:|
| ![Командировка 1](docs/images/Trip_trip2.jpeg) | ![Командировка 2](docs/images/Trip_trip1.jpeg) |

| Распознавание чеков | Загрузка в каталог |
|:---:|:---:|
| ![Командировка 3](docs/images/Trip_down1.jpeg) | ![Командировка 4](docs/images/Trip_trip4.jpeg) |

### Генерация документов
| Документы ДО поездки | Документы ПОСЛЕ поездки |
|:---:|:---:|
| ![Генерация 1](docs/images/Trip_trip3.jpeg) | ![Генерация 2](docs/images/Trip_gen1.jpeg) |

### Скачивание документов
| Предпросмотр | Готовые документы |
|:---:|:---:|
| ![Скачивание 1](docs/images/Trip_down2.jpeg) | ![Скачивание 2](docs/images/Trip_gen2.jpeg) |
